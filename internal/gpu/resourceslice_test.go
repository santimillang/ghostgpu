...
func TestBuildResourceSliceTopLevelShape(t *testing.T) {
	slice := BuildResourceSlice(testPool(8, 4, false), testModel(), nodeA, NodeState{})
...
func TestBuildResourceSliceDeviceNamesAreSequential(t *testing.T) {
	slice := BuildResourceSlice(testPool(4, 0, false), testModel(), nodeA, NodeState{})
...
func TestBuildResourceSliceDeviceAttributes(t *testing.T) {
	slice := BuildResourceSlice(testPool(8, 4, true), testModel(), nodeA, NodeState{})
...
func TestBuildResourceSliceMemoryCapacity(t *testing.T) {
	slice := BuildResourceSlice(testPool(2, 0, false), testModel(), nodeA, NodeState{})
...
func TestBuildResourceSliceIsDeterministic(t *testing.T) {
	a := BuildResourceSlice(testPool(8, 4, true), testModel(), nodeA, NodeState{})
	b := BuildResourceSlice(testPool(8, 4, true), testModel(), nodeA, NodeState{})
...
func TestBuildResourceSliceDiffersPerNode(t *testing.T) {
	a := BuildResourceSlice(testPool(2, 0, false), testModel(), nodeA, NodeState{})
	b := BuildResourceSlice(testPool(2, 0, false), testModel(), nodeB, NodeState{})
...
func TestBuildResourceSliceAtMaxDeviceCount(t *testing.T) {
	slice := BuildResourceSlice(testPool(128, 8, true), testModel(), nodeA, NodeState{})
