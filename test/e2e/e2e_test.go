...
const namespace = "ghostgpu-system"

// serviceAccountName created for the project
const serviceAccountName = "ghostgpu-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "ghostgpu-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "ghostgpu-metrics-binding"
...
var _ = Describe("Manager", Ordered, func() {
	...
	// The namespace, CRDs, and controller-manager are installed once for the
	// whole suite in BeforeSuite, so that every top-level container sees a
	// deployed manager regardless of the order Ginkgo randomizes them into.
	AfterAll(func() {
